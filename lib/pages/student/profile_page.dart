...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Öğrenci Profili', style: GoogleFonts.poppins()),
      ),
      body: _isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            // Mentor'dan farkı: Kullanıcı adı yerine Okul Numarası gösteriliyor.
            _buildInfoTile(Icons.pin, 'Okul Numarası', _number),
            _buildInfoTile(Icons.email, 'Email', _email),

            const Divider(height: 40, thickness: 1),

            // Şifre Değiştirme Formu (Mentor ile aynı)
            ...
            ElevatedButton(
              ...
              child: Text('Şifreyi Güncelle', style: GoogleFonts.poppins()),
            ),

            const SizedBox(height: 40),
            // Çıkış Yap Butonu (Mentor ile aynı)
            ElevatedButton.icon(
  ...
  // Bilgileri göstermek için yardımcı widget
