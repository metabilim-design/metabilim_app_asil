// lib/pages/admin/admin_exam_detail_page.dart

import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:metabilim/models/exam_result.dart';

class AdminExamDetailPage extends StatelessWidget {
  final StudentExamResult result;

  const AdminExamDetailPage({super.key, required this.result});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(result.fullName, style: GoogleFonts.poppins()),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Ders Sonuçları", style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold)),
      ...
      child: DataTable(
        ...
        rows: result.lessonResults.map((lesson) {
          return DataRow(cells: [
            ...
            DataCell(Text(lesson.correct.toStringAsFixed(0), style: GoogleFonts.poppins(color: Colors.green.shade800))),
            DataCell(Text(lesson.wrong.toStringAsFixed(0), style: GoogleFonts.poppins(color: Colors.red.shade800))),
