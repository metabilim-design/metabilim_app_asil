...
import 'package:metabilim/pages/coach/homework_flow/select_date_range_page.dart';
  ...
  Future<void> _loadStudents() async {
    ...
    try {
      final snapshot = await FirebaseFirestore.instance
          .collection('users')
      // DÜZELTME: 'student' yerine veritabanındaki doğru değer olan 'Ogrenci' yazıldı.
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(student.schoolNumber != null ? 'Okul No: ${student.schoolNumber}' : 'Okul No Yok'),
                    onTap: () {
                      setState(() {
        ...
        child: ElevatedButton(
          onPressed: _selectedStudent == null
            ...
            Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => SelectDateRangePage(student: _selectedStudent!),
            ));
          },
